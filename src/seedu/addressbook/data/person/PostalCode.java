...
public class PostalCode {
    ...
    public static final String EXAMPLE = "523123";
    public static final String MESSAGE_POSTAL_CODE_CONSTRAINTS = "Address postal code should contain only numbers";
    ...
    /**
     * Validates given address postalCode.
     *
